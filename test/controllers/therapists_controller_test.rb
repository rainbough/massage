...
class TherapistsControllerTest < ActionController::TestCase
  ...
  test "should create therapist" do
    assert_difference('Therapist.count') do
      post :create, therapist: { business: @therapist.business, email: @therapist.email, location: @therapist.location, name: @therapist.name, password: @therapist.password }
    end
  ...
  test "should update therapist" do
    patch :update, id: @therapist, therapist: { business: @therapist.business, email: @therapist.email, location: @therapist.location, name: @therapist.name, password: @therapist.password }
    assert_redirected_to therapist_path(assigns(:therapist))
  end
